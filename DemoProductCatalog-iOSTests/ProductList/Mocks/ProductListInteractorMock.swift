...
class ProductListInteractorMock: ProductListInteractorInterface {
    func getData(for page: Int, completion: @escaping (GetProductsList.Response?, GetProductsList.Failure?, Error?) -> Void) {
        switch page {
        case 1:
            completion(GetProductsList.Response(status: 200, message: "Success", body:
                GetProductsListResponseBody(currentPage: 1, firstPageURL: nil, from: 1, lastPage: 2, lastPageURL: nil, nextPageURL: nil, path: "", perPage: 10, prevPageURL: nil, to: 10, total: 15, data: [
        ...
        case 2:
            completion(GetProductsList.Response(status: 200, message: "Success", body:
                GetProductsListResponseBody(currentPage: 2, firstPageURL: nil, from: 11, lastPage: 2, lastPageURL: nil, nextPageURL: nil, path: "", perPage: 10, prevPageURL: nil, to: 12, total: 12, data: [
        ...
        case let pageNumber where pageNumber > 2:
            completion(GetProductsList.Response(status: 200, message: "Success", body:
                    GetProductsListResponseBody(currentPage: 3, firstPageURL: nil, from: nil, lastPage: 2, lastPageURL: nil, nextPageURL: nil, path: "", perPage: 10, prevPageURL: nil, to: nil, total: 12, data: [])),
            nil, nil)
        default:
            completion(GetProductsList.Response(status: 200, message: "Success", body:
                    GetProductsListResponseBody(currentPage: 3, firstPageURL: nil, from: nil, lastPage: 2, lastPageURL: nil, nextPageURL: nil, path: "", perPage: 10, prevPageURL: nil, to: nil, total: 12, data: [])),
